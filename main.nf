...
workflow {
    ...
    if (params.mode == 'ont') {
        ...
        def all_completed = ont_results.Published_Results.mix(amr_html_done).collect()
    ...
    if (params.mode == 'iln') {
        ...
        def all_completed = iln_results.Published_Results.mix(amr_html_done).collect()
    ...
    if (params.mode == 'sp') {
        ...
        def all_completed = sp_results.Published_Results.mix(amr_html_done).collect()
    ...
    if (params.mode == 'lp') {
        ...
        def all_completed = lp_results.Published_Results.mix(amr_html_done).collect()
